RAW_VIDEO_DIR = '../../../data/nano/' #'../input/raw/'
TRAIN_IMG_DIR = '/opt/data_fast/pri_matrix/train_img/'
TEST_VIDEO_DIR = '../../../data/nano/'  #'../input/raw_test/'
UNUSED_VIDEO_DIR = '../../../data/nano/'  #'../input/raw_unused/'
UNUSED_IMG_DIR = '../input/raw_unused_img/'
SMALL_VIDEO_DIR = '../../../data/nano/'  #'../input/small/'
