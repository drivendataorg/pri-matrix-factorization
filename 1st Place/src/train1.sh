...
#python3.6 single_frame_cnn.py train --model resnet50_avg --fold 1
#python3.6 single_frame_cnn.py train --model resnet50_avg --fold 2
#python3.6 single_frame_cnn.py train --model resnet50_avg --fold 3
#python3.6 single_frame_cnn.py train --model resnet50_avg --fold 4

python3.6 single_frame_cnn.py generate_prediction --model resnet50_avg --fold 1 --weights ../output/checkpoints/resnet50_avg_fold_1/checkpoint-012*
python3.6 single_frame_cnn.py generate_prediction --model resnet50_avg --fold 2 --weights ../output/checkpoints/resnet50_avg_fold_2/checkpoint-012*
python3.6 single_frame_cnn.py generate_prediction --model resnet50_avg --fold 3 --weights ../output/checkpoints/resnet50_avg_fold_3/checkpoint-012*
python3.6 single_frame_cnn.py generate_prediction --model resnet50_avg --fold 4 --weights ../output/checkpoints/resnet50_avg_fold_4/checkpoint-012*
